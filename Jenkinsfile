    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/Lakshmidurga242424/testing-sonar.git'
            }
        }
        ...
        stage('API Testing') {
            steps {
                script {
                    ...
                    def getResponse = sh(script: 'curl -X GET http://192.168.56.151:8081/webapp-0.2/', returnStdout: true).trim()
